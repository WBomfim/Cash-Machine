...
public class CaixaEletronico {	
  ...
  public static void main(String[] args) {	
    ...
    try (Scanner sc = new Scanner(System.in)) {	
      ...
      /*	
       * adiciona algumas pessoas clientes ao banco criando ja uma conta poupanca e em seguida	
       * adiciona uma conta corrente para essas pessoas	
       */	

      // pessoa cliente 1	
      PessoaCliente pessoaCliente1 =	
          banco.adicionarPessoaCliente("Alexiania Pereira", "842.074.410-77", "1234");	
      Conta ccCliente1 = new Conta("Corrente", pessoaCliente1, banco);	
      Conta cpCliente1 = new Conta("Poupança", pessoaCliente1, banco);	
      ...
      Conta ccCliente2 = new Conta("Corrente", pessoaCliente2, banco);	
      Conta cpCliente2 = new Conta("Poupança", pessoaCliente2, banco);	
      ...
      Conta ccCliente3 = new Conta("Corrente", pessoaCliente3, banco);	
      Conta cpCliente3 = new Conta("Poupança", pessoaCliente3, banco);	
      banco.adicionarConta(ccCliente3);	
      banco.adicionarConta(cpCliente3);	
      // laco infinito	
      while (true) {	
            ...
            if (op == 1) {	
              ...
              do {	
                System.out.printf(	
                    ...
                    pessoaClienteAutenticada.retornarNumeroDeContas());	
                conta = sc.nextInt() - 1;	
                if (conta < 0 || conta >= pessoaClienteAutenticada.retornarNumeroDeContas()) {	
              ...
              do {	
                System.out.printf(	
                    "Entre o número (1-%d) para selecionar a conta para " + "o saque: ",	
                    pessoaClienteAutenticada.retornarNumeroDeContas());	
                deConta = sc.nextInt() - 1;	
                if (deConta < 0 || deConta >= pessoaClienteAutenticada.retornarNumeroDeContas()) {	
              ...
              do {	
                ...
                if (paraConta < 0	
                    || paraConta >= pessoaClienteAutenticada.retornarNumeroDeContas()) {	
                  System.out.println("Índice de conta inválido, tente novamente.");	
              ...
              do {	
                ...
                if (daConta < 0 || daConta >= pessoaClienteAutenticada.retornarNumeroDeContas()) {	
                  System.out.println("Índice de conta inválido, tente novamente.");	
                } else {	
                  break;	
                }	
